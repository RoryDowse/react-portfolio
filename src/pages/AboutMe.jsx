...
export default function AboutMe() {
    return (
        <section className="about-me">
            <Helmet>
                <title>About Me | Rory Dowse | Software Engineer</title>
            ...
            <div className="about-me-content">
                ...
                <div className="about-me-bio">
                    ...
                    <p>With extensive experience as a front-end developer, I specialize in creating dynamic and responsive websites and applications using modern technologies like React, APIs, JavaScript (ES6+), HTML5, and CSS3. As a specialist in the MERN stack, my work emphasizes performance optimization and delivering seamless user experiences, bridging creativity with cutting-edge functionality.</p>
