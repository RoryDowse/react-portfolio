        ...
        <section className="about-me">
            <div className="about-me-content">
                ...
                <div className="about-me-bio">
                    <h2>About Me</h2>
                    <p>What do Geocities and Longhorn have in common? Hint: it’s more than just a (questionable) UI!</p>
...
<p>My projects include front-facing business pages, a keyboard application, a metronome application, and various applications from my bootcamp experience, including a bespoke finance calculator. I also lead a weekly study group at the Bootcamp, incorporate agile methodologies into our scrum meetings to foster impactful contributions, and ensure we all succeed as a team. I believe it is essential to work with utmost integrity so that everyone is seen, heard, and feels like they belong, enabling us to architect, code, and ship the highest quality software in our workplace.</p>
